...
This package includes `index1.html`, an experimental studio-portal homepage.

To preview it on GitHub Pages, upload all files and visit:

`https://cinaedvsstudios.github.io/cinaedvs/index1.html`

It does not replace `index.html`. If you prefer this version later, rename `index1.html` to `index.html` after backing up the original.
